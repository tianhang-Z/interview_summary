...
2，分配方式：栈由系统自动分配，存放布局变量、形参、返回值   ；堆手动使用库函数申请（由动态内存分配器 管理空闲空间链表）
...
![image-20250527155753166](./image/c++知识点_image/image-20250527155753166.png)

![image-20250527155744964](./image/c++知识点_image/image-20250527155744964.png)
